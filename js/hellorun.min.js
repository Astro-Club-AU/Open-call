...
window.onload = function() {
    ...
    stopfinish : function(){
        this.director.stop(), this.station.stop(), this.player.stop(), this.app.mouseTouch.stop(), this.sound.stop(), this.sound.play("stop"), this.view.setClearColor(16777215), HEY.Sys.mobile || (this.view.postprocessing.enabled = !1), this.gates.stop(), this.home.start(), HEY.Input.isPointerLocked && HEY.Input.instance.unlockPointer(), this.score > this.best && (this.best = this.score, HEY.Sys.localStorage && (localStorage["hellorun.best"] = this.best)), HEY.Sys.releaseBuild || console.log("Game: stop()"), this.gameplay = !1, this.gui.setScreen("loadingfinish")
    },
    pause: function() {
    ...
    onGate: function(a) {
        ...
        if (this.score > 19) this.stopfinish()
    },
    ...
    update: function(a) {
        if (this.webAudio && !this.mute && (this.musicOn && this.spectrum.update(a), this.debug && HEY.Input.keyRight && this.music.pos(this.music.pos() + .2), this.musicOff)) {
            var b = this.playbackRate.value - a;
            .01 > b ? (this.music.stop(), this.musicOff = !1) : this.playbackRate.value = b
        }
    },
    ...
    BLACK: "black",
    WHITE: "white",
    LOADING_INFO: ["WELCOME TO ASTRO CLUB AU", "HEADPHONES RECOMMENDED", "LOADING"],
    CANCEL: "CANCEL",
    SETTINGS: "SETTINGS",
    CREDITS: "CREDITS",
    SHARE: "SHARE",
    FULLSCREEN: "FULL SCREEN",
    TITLE: 'Reach a Score of 10 for a suprise from ASTRO CLUB AU',
    HOME_INFO_TOUCH: ["TOUCH TO START"],
    HOME_INFO_DESKTOP: ["CLICK TO START", "PRESS SPACE TO START", "TAP LEAP TO START"],
    GAME_INFO: {
        touch: ["SWIPE UP & DOWN", "SECOND TOUCH TO ACCELERATE","SCORE 20 POINTS TO UNLOCK"],
        mouse: ["MOVE MOUSE UP & DOWN", "CLICK OR PRESS SHIFT TO ACCELERATE","SCORE 20 POINTS TO UNLOCK"],
        mouselock: ["MOVE MOUSE UP & DOWN", "CLICK TO ACCELERATE","SCORE 20 POINTS TO UNLOCK"],
        key: ["PRESS UP & DOWN ARROW KEYS", "PRESS SHIFT TO ACCELERATE","SCORE 20 POINTS TO UNLOCK"],
        leap: ["MOVE HAND UP & DOWN", "PRESS SHIFT TO ACCELERATE","SCORE 20 POINTS TO UNLOCK"]
    },
    ...
    CALIBRATE_WAIT: "...",
    TWITTER_TEXT: "Check out Astro Club AU, an Open Call with music by @DuToncMusic ",
    FACEBOOK: '<a href="javascript:void(0)" onclick="HELLORUN.GUI.instance.shareOnFacebook();">FACEBOOK</a>',
    EMAIL_SUBJECT: "HelloRun",
    EMAIL_TEXT: "Check out Astro Club AU, an Open Call with music by Du Tonc:\n\n",
    ...
    update: function(a) {
        ...
        switch (this.screenName) {
            case "loading":
                ...
                break;
            case "home":
                if (this.bottomLeftButton.updateTFX(a), this.fullScreenEnabled() && this.bottomRightButton.updateTFX(a), this.title.updateTFX(a), this.infoTime += a, this.infoTime > 2.5) {
            ...
            case "loadingfinish":
                // this.info.hide();
                this.title.show();
                this.game.frontEnd.show("hellorun");
                this.title.setText("Thanks for playing!! Stay on the page while we load you the suprise.");
                setTimeout(function(){
    ...
    setScreen: function(a) {
        ...
        switch (this.screenName) {
            ...
            case "leap":
                ...
                break;
            case "webgl":
                this.webgl.hide(), this.info.hide(), this.info.setInteractive(!1);break;
        }
    ...
    this.gateS = .6, this.gateL = .7, this.hue = Math.random(), this.hue2 = 0, this.initialize(a)
...
var Detector = {
    ...
    webgl: function() {
        try {
            ...
            return !!window.WebGLRenderingContext && !!a.getContext("experimental-webgl")
        } catch (b) {
            return !1
        }
    }(),
